...
@Component
public class OpenInterestChainPersister {

    @Autowired
    private MongoTemplate mongoTemplate;

    public OpenInterestChainResponse persist(OpenInterestChainResponse openInterestChainResponse, final String symbol) {
